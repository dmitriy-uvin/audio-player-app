...
import { LikedPageHeaderBlock, MainPageHeaderBlock } from '../header-blocks';
...
export const Header = () => {
  ...
  return (
    <div className='h-fit bg-gradient-to-b from-emerald-800 p-6'>
      ...
      {path === AppRoutes.MAIN_PAGE && <MainPageHeaderBlock />}
      {path === AppRoutes.LIKED_PAGE && <LikedPageHeaderBlock />}
    </div>
  );
}